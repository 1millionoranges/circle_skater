...
int num_halfpipes = 0;
struct halfpipe_object* halfpipe_object_init(float x, float y, float radius, float width){
    struct halfpipe_object* new_halfpipe_obj = malloc(sizeof(struct halfpipe_object));
    new_halfpipe_obj->position.x = x;
    new_halfpipe_obj->position.y = y;
...
void make_halfpipes(){
    struct halfpipe_object* new_halfpipe = halfpipe_object_init(0,0, 3.0, 3.0);
    struct halfpipe_object* new_halfpipe2 = halfpipe_object_init(13,0, 3.0, 3.0);
}
